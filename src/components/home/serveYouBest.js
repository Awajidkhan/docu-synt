...
const ServeYouBest = () => {
  ...
  const optionDescriptions = {
    "What we do to serve you best":
      "Is bill line item data entry overwhelming? Eliminate the need for any manual data entry with",
  ...
  return (
    <div className="container-class pt-[360px] pb-[150px]">
      <div className="flex  items-center justify-between ">
        {selectedOption && (
          <div className="  h-[120px]">
            <h2 className="w-[608px] text-[#222] text-[40px] font-medium">
              {selectedOption}
              <span className="text-[#00D588]">.</span>
            </h2>
            <div className="pt-[20px]">
              <p className="text-[#222] w-[490px] text-[18px] font-normal">
        ...
        <div className="flex flex-col justify-between ">
          <div className="flex items-center justify-end gap-[20px]">
            <div
              ...
              onClick={() => handleArrowClick("What we do to serve you best")}
              style={{
            ...
            <div
              ...
              onClick={() => handleArrowClick("Lorem Ipsum is simply dummy")}
              style={{
      ...
      {/* cards */}
      <div className="pt-[60px] flex items-start justify-between">
        <div className="border border-[#CCC] rounded-[10px] w-[30%] pt-[30px] px-[30px] h-[380px]">
        ...
        <div className="border border-[#CCC] rounded-[10px] w-[30%] pt-[30px] px-[30px] h-[380px]">
          ...
          <div className="pt-[28px]">
            ...
            <p className="w-[310px] text-[16px] font-light text-[#222] pt-2.5">
              Automate your workflows and gain better insight into the status of
              approvals and payments all while reducing costs tied to errors or
              late disbursements.
            </p>
          </div>
        </div>
