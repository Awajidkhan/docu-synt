        ...
        <div className="pt-[100px]">
          <div className="flex items-start justify-between">
            <div className="w-[32%]">
              ...
              <p className="w-[396px] text-[#666] text-[14px] font-[400] py-[30px]">
          ...
          <div className="container-class">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-[50px]">
                <h1 className="text-[#FFF] font-semibold text-[16px] cursor-pointer">Terms</h1>
                <h1 className="text-[#FFF] font-semibold text-[16px] cursor-pointer">Privacy</h1>
              </div>
            </div>
          </div>
        </div>
